            ...
            <main>
                <section>
                    <div className="dynamic-background">
                        <h1 style={{color: "#12ac8e"}}>Welcome To The Healthy Tips<br />For You.</h1>
                ...
                <section>
                    ...
                    <div id="diet"><img src="src/Images/diet-and-nutrition.jpg" alt="image" width="50"/></div>
                ...
                <section>
                    ...
                    <div>
                        ...
                        <ul>
                            <li><span>Berries</span>: Rich in antioxidants like vitamin C, berries such as<br/>strawberries, blueberries, and raspberries help fight free <br/> radicals that can damage skin cells and accelerate aging.</li>
                            <li><span>Oranges</span>: Loaded with vitamin C, oranges promote collagen<br/> production, which helps keep the skin firm and youthful-looking.</li>
                            <li><span>Avocado</span>: Packed with healthy fats and vitamin E, avocados<br/> moisturize and nourish the skin, promoting a healthy glow.</li>
                            <li><span>Papaya</span>: Contains an enzyme called papain, which acts as<br/> a natural exfoliant, removing dead skin cells and promoting<br/>skin renewal.</li>
                            <li><span>Watermelon</span>: High in water content hydrates the skin, while <br/> vitamins A and C help repair and protect against sun damage.</li>
                        </ul>
                        <br/>
                        ...
                        <ul>
                            <li><span>Spinach</span>: Rich in vitamina A, C and E, as well as antibiotics,<br/> spinach helps to repar and protect the skin from damage<br/> caused by UV rays and environmental polutants.</li>
                            <li><span>Sweet potatoes</span>: Loaded with beta-carotene, sweet potatoes<br/> are converted into vitaminA in the body, which protects skin<br/> cell turnover and contributes to a glowing complexion.</li>
                            <li><span>Bell papers</span>: High in vitamin C, bell papers help boost collagen<br/> production, which maintains skin elasticity premature aging.</li>
                            <li><span>Carrots</span>: Another excellent source of beta-carotene, carrots<br/> contribute to skin health by promoting cell renewal and <br/>protected against sun damage.</li>
                            <li><span>Broccoli</span>: Packed with Vitamin A, C and K, as well as anti-biotics<br/> like sulphoraphane, broccoli helps detoxify the skin and commbat<br/> inflammation, leading to clearer complexion.</li>
                        </ul>
                    </div>
                    ...
                    <ul>
                        <li><span>Eicosapentaenoic acid(EPA)</span>: EPA helps regulate oil production,<br/> reduce inflammation, and protect against sun damage. It can be<br/> found in fatty fish such as salmon, mackrel, and sardines.</li>
                        <li><span>Docosahexaenoic acid(DHA)</span>: DHA is essential for maintaining the<br/> structural integrity  of skin cell membranes, promoting elasticity<br/> and smoothness like EPA, it is ambundant in fatty fish.</li>
                    </ul>
                    <h5>
                        Both EPA nad DHA are important for maintaining healthy skin, so incorporating sources of omega-3 fatty acids into your diet, such as fish or plant-based alternatives like<br/> flaxseeds, chia seeds, and walnuts, can benefit your skin's overall health and appearance.
                    </h5>
                    <br/>
                    <h3>*Stay Hydrated</h3>
                ...
                <section>
                    ...
                    <div id="gain"><img src="src/Images/gainweight.jpg" alt="image"/></div>
                </section>
